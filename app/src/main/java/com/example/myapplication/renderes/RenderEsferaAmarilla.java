...
public class RenderEsferaAmarilla implements GLSurfaceView.Renderer {
    ...
    private float[] colorLuz0 = {1.0f, 1.0f, 0.0f,1.0f};
    ...
    public void onSurfaceChanged(GL10 gl10, int ancho, int alto) {
        ...
        gl10.glLoadIdentity();
        GLU.gluPerspective(gl10, 45.0f, relacionAspecto, 1, 100);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        gl.glLoadIdentity();
        posLuz0 = new float[]{0.0f,traslacion,5.0f,1.0f};
        gl.glLightfv(LUZ_O, gl.GL_POSITION, Funciones.generarBuffer(posLuz0));
        gl.glLightfv(LUZ_O,gl.GL_AMBIENT,Funciones.generarBuffer(colorLuz0));
        ...
        traslacion += 0.2f; // Ajusta la velocidad de rotación del segundo cubo
    }
