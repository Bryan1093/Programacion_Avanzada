...
public class Rio {
    ...
    public void dibujar (GL10 gl){
        ...
        // frontal:
        bufferIndices.position(0);
        gl.glColor4f(0.0f, 0.5f, 0.9f, 1.0f);  // Color azul tipo agua
        gl.glDrawElements(gl.GL_TRIANGLE_FAN, 6, gl.GL_UNSIGNED_BYTE, bufferIndices);

// superior:
        bufferIndices.position(6);
        gl.glColor4f(0.0f, 0.5f, 0.9f, 1.0f);  // Color rosa claro
        gl.glDrawElements(gl.GL_TRIANGLE_FAN, 6, gl.GL_UNSIGNED_BYTE, bufferIndices);

// izquierda:
        bufferIndices.position(12);
        gl.glColor4f(0.0f, 0.5f, 0.9f, 1.0f);  // Color verde claro
        gl.glDrawElements(gl.GL_TRIANGLE_FAN, 6, gl.GL_UNSIGNED_BYTE, bufferIndices);

// derecha:
        bufferIndices.position(18);
        gl.glColor4f(0.0f, 0.5f, 0.9f, 1.0f);  // Color amarillo claro
        gl.glDrawElements(gl.GL_TRIANGLE_FAN, 6, gl.GL_UNSIGNED_BYTE, bufferIndices);

// abajo:
        bufferIndices.position(24);
        gl.glColor4f(0.0f, 0.5f, 0.9f, 1.0f);  // Color morado claro
        gl.glDrawElements(gl.GL_TRIANGLE_FAN, 6, gl.GL_UNSIGNED_BYTE, bufferIndices);

// atras:
        bufferIndices.position(30);
        gl.glColor4f(0.0f, 0.5f, 0.9f, 1.0f);  // Color naranja claro
        gl.glDrawElements(gl.GL_TRIANGLE_FAN, 6, gl.GL_UNSIGNED_BYTE, bufferIndices);
