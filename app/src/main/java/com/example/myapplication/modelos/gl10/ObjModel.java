...
import com.example.myapplication.utilidades.ObjFileReader;
...
public class ObjModel {
    ...
    public ObjModel(String archivoOBJ, float[] colorPorTriangulo, Context context) {
        this.colorPorTriangulo = colorPorTriangulo;

        //Carga la geometria del objeto .obj
