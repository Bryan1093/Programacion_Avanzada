...
public class PlanoIluminacionMipMap {
    ...
    public PlanoIluminacionMipMap(boolean utilizarMipMap){
...
//
    ...
    public  void cargarImagenesTextura (GL10 gl, Context context, int idImagen, int indice, int nivel){
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inScaled = false;

        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), idImagen, options);
